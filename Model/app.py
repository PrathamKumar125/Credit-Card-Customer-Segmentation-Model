...
df = pd.read_csv("Model/Clustered_Customer_Data.csv")
st.set_option('deprecation.showPyplotGlobalUse', False)

st.markdown('<style>body{background-color: Blue;}</style>',unsafe_allow_html=True)
st.title("Credit Card Customer Segmentation Model")
...
if submitted:
    ...
    cluster_df1= cluster_df1.drop(cluster_df1.columns[0], axis=1)
